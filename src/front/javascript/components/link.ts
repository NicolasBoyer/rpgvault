...
const REPLACEZONE = (pFragment: Record<string, string>): void => {
    Utils.replaceChildren(<HTMLElement>document.querySelector('[data-replaced-zone]'), document.createRange().createContextualFragment(pFragment.text) as unknown as HTMLElement)
